...
export class MaintenancePackageComponent implements OnInit {
  ...
  packageDurations: Array<any> = [
    { text: '3 months', value: '3' },
    { text: '6 months', value: '6' },
    { text: '12 months', value: '12' }
  ];
  packageVisits: Array<any> = [
    { text: '15', value: '15' },
    { text: '30', value: '30' },
  ...
  getPackagePrice() {
    ...
    if (this.isAC_Selected) {
      this.packageService.getACPackagePrice(this.txtACCount)
        .subscribe(res => {
          this.price = res;
      ...
      if (this._visit === 'unlimited') {
        this.packageService.getUnlimitedPackagePrice(this._duration, this.txtArea, this.isServiceSelected().toString())
          .subscribe(res => {
            this.price = res;
            this.navButtonText = this.BOOK_PACKAGE;
            this.showNavbar = false;
        ...
        this.packageService.getPackagePrice(this._duration, this._visit)
          .subscribe(res => {
            this.price = res;
            this.navButtonText = this.BOOK_PACKAGE;
            this.showNavbar = false;
  ...
  submitPackageForm() {
    this.loaderService.display(true);
    this.packageService.saveForm(this.packageForm)
      .subscribe(res => {
